...
public interface Directory {
	...
	Result<Void> writeFileSec(String filename, String userId, ExtendedFileInfo file, Long version);

	Result<Void> deleteFile(String filename, String userId, String password, Long version);
	
	Result<Void> deleteFileSec(String filename, String userId, Long version);

	Result<Void> shareFile(String filename, String userId, String userIdShare, String password, Long version);
	
	Result<Void> shareFileSec(String filename, String userId, String userIdShare, Long version);

	Result<Void> unshareFile(String filename, String userId, String userIdShare, String password, Long version);
	
	Result<Void> unshareFileSec(String filename, String userId, String userIdShare, Long version);
